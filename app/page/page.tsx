      ...
      <section className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6 lg:px-12">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="mb-6 sm:mb-8 flex justify-center">
            <div className="relative w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 rounded-full bg-gradient-to-br from-orange-400 via-pink-500 to-purple-600 p-1">
              <div className="w-full h-full rounded-full bg-gray-200 flex items-center justify-center text-4xl sm:text-5xl lg:text-6xl overflow-hidden">
                <Image
                  src="/moredev.png"
                  width={150}
                  height={150}
                  alt="Success Atulegwu picture  holder"
                  className="w-[150px] h-[150px] filter grayscale-[80%] bg-amber-50 object-cover rounded-full "
                />
              </div>
            </div>
          </div>
          ...
          {/* Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight px-2" style={{ fontFamily: "'Poppins', sans-serif", letterSpacing: '-0.02em' }}>
            ...
            <span className="relative inline-block group mx-2">
              <span className="relative z-10 bg-gradient-to-r from-orange-400 via-pink-500 to-purple-600 bg-clip-text text-transparent font-extrabold animate-gradient" style={{
                backgroundSize: '200% auto',
                animation: 'gradient 3s linear infinite'
              }}>
                code
              </span>
              <span className="absolute -inset-1 bg-gradient-to-r from-orange-400 via-pink-500 to-purple-600 rounded-lg opacity-30 blur-xl group-hover:opacity-50 transition-opacity"></span>
              <span className="absolute -bottom-1 left-0 w-full h-1 bg-gradient-to-r from-orange-400 via-pink-500 to-purple-600 rounded-full shadow-lg shadow-pink-500/50"></span>
            </span>
          ...
          {/* Description */}
          <p className="text-gray-300 text-lg sm:text-xl lg:text-2xl max-w-3xl mx-auto mb-8 sm:mb-10 leading-relaxed px-4" style={{ fontFamily: "'Caveat', cursive", fontWeight: 600, letterSpacing: '0.02em' }}>
            I am a seasoned full-stack software engineer with over 8 years of professional experience, specializing in backend and frontend development.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-12 sm:mb-20 px-4">
            <button
              ...
              className="px-6 sm:px-8 py-3 bg-primary text-white font-medium rounded-full transition-all text-sm sm:text-base disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2 justify-center shadow-lg hover:shadow-xl hover:brightness-110 active:brightness-95"
            >
              {isDownloading ? (
                <>
            ...
            <Link
              href="/community"
              className="group relative inline-flex items-center justify-center px-6 sm:px-8 py-3 rounded-full text-white overflow-hidden transition-all duration-300 text-sm sm:text-base"
            >
              <span
                className="pointer-events-none absolute inset-0 rounded-full p-[2px] transition-transform"
                style={{
                  background: 'conic-gradient(from 0deg, black, #4b5563 50%, black)',
              ...
              ></span>
              <span className="relative z-10">View Community Services</span>
            </Link>
          </div>
        </div>
      </section>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="flex justify-center mb-10 sm:mb-16">
              <div className="relative inline-block">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-green-500 to-transparent animate-pulse"></div>
              </div>
            </div>
              ...
              <div className="pt-6 border-t border-gray-800">
                ...
                <div className="flex justify-center sm:justify-start gap-4">
                  <a
                    ...
                    className="group p-3 bg-gray-800/50 hover:bg-gradient-to-br hover:from-green-600 hover:to-emerald-600 border border-gray-700 hover:border-transparent rounded-lg transition-all hover:scale-110"
                    aria-label="WhatsApp"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group p-3 bg-gray-800/50 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-600 border border-gray-700 hover:border-transparent rounded-lg transition-all hover:scale-110"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group p-3 bg-gray-800/50 hover:bg-gradient-to-br hover:from-blue-600 hover:to-cyan-600 border border-gray-700 hover:border-transparent rounded-lg transition-all hover:scale-110"
                    aria-label="Twitter"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group p-3 bg-gray-800/50 hover:bg-gradient-to-br hover:from-red-600 hover:to-rose-600 border border-gray-700 hover:border-transparent rounded-lg transition-all hover:scale-110"
                    aria-label="YouTube"
                  >
                    ...
                    <div className="flex gap-3">
                      {projects[selectedProject].liveUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-full text-sm font-medium transition-all hover:scale-105"
                        >
